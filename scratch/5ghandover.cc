...
void printParams(Ptr<NetDevice> ue,uint16_t cellId){
  ...
  std::cout << "Called" << "\n";
  //  std:: cout  << "RSRP : "<< ue->GetObject<MmWaveUeNetDevice> ()->GetRrc ()->getCellRSRP(cellId) << "\n";
  //  std:: cout << "RSRQ :" <<  ue->GetObject<MmWaveUeNetDevice> ()->GetRrc ()->getCellRSRQ(cellId) << "\n";
...
main (int argc, char *argv[])
{
 ...
 Ptr<MmWaveHelper> mmwaveHelper = CreateObject<MmWaveHelper> ();
  ...
  Simulator::Schedule (Seconds(1), &printParams,ueDevs.Get(0) , 1 );
  Simulator::Schedule (Seconds(1), &printParams,ueDevs.Get(0) , 2 );
  Simulator::Schedule (Seconds(2), &printParams,ueDevs.Get(0) , 1 );
  Simulator::Schedule (Seconds(2), &printParams,ueDevs.Get(0) , 2 );
  ...
  AnimationInterface anim("5gHand.xml");
