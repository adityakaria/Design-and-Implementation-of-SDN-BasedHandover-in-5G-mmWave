...
// sourceRrc->SendHandoverRequest (rnti, targetCellId);
  ...
  //This is for mmWave ue phy sinr values callback trace
  ...
  for(int i=0;i<numberOfUes;i++){
    Simulator::Schedule (Seconds(0.1) , &reportParams , ueDevs , i );
  }


  Simulator::Stop (Seconds (3));

  // AnimationInterface anim("A_mmHo2.xml");
