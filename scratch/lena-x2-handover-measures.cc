...
void printParams(Ptr<NetDevice> ue,uint16_t cellId){
   // LteUeRrc ueRrc = ue->GetObject<MmWaveUeNetDevice> ()->GetRrc ();
  std::cout << "Called" << "\n";
  //  std:: cout  << "RSRP : "<< ue->GetObject<LteUeNetDevice> ()->GetRrc ()->getCellRSRP(cellId) << "\n";
  //  std:: cout << "RSRQ :" <<  ue->GetObject<LteUeNetDevice> ()->GetRrc ()->getCellRSRQ(cellId) << "\n";
...
main (int argc, char *argv[])
{
  ...
  Simulator::Schedule (Seconds(1), &printParams,ueLteDevs.Get(0) , 1 );
  Simulator::Schedule (Seconds(1), &printParams,ueLteDevs.Get(0) , 2 );
  Simulator::Schedule (Seconds(2), &printParams,ueLteDevs.Get(0) , 1 );
  Simulator::Schedule (Seconds(2), &printParams,ueLteDevs.Get(0) , 2 );
  ...
  AnimationInterface anim("lteHan-2.xml");
